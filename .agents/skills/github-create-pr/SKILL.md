...
Add user authentication flow with Supabase integration. Implements login, signup, and password reset functionality with proper error handling and loading states.

## Changes

- **app/auth/login/page.tsx**: Create login page with form validation and Supabase auth
- **app/auth/signup/page.tsx**: Create signup page with email verification flow
- **lib/supabase/auth.ts**: Add authentication helper functions and session management
- **middleware.ts**: Add route protection for authenticated routes
- **components/auth/AuthForm.tsx**: Reusable authentication form component with validation
```
