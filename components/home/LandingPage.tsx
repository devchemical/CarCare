    ...
    <>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="mb-12 text-center">
          <h2 className="text-foreground mb-4 text-3xl font-bold">Todo lo que necesitas para cuidar tu vehículo</h2>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
            ...
            <CardContent>
              <CardDescription className="text-center">
                Protegemos el acceso con autenticación, conexiones HTTPS y controles por cuenta.
              </CardDescription>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="bg-card/30 rounded-3xl p-4 sm:p-8 lg:p-12">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              <h2 className="text-foreground mb-6 text-3xl font-bold">Beneficios de usar Keepel</h2>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <CheckCircle className="text-primary mt-0.5 h-6 w-6 flex-shrink-0" />
                  <div>
                    <h3 className="text-foreground font-semibold">Ahorra dinero</h3>
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="text-primary mt-0.5 h-6 w-6 flex-shrink-0" />
                  <div>
                    <h3 className="text-foreground font-semibold">Prolonga la vida útil</h3>
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="text-primary mt-0.5 h-6 w-6 flex-shrink-0" />
                  <div>
                    <h3 className="text-foreground font-semibold">Aumenta el valor de reventa</h3>
                    <p className="text-muted-foreground">
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="text-primary mt-0.5 h-6 w-6 flex-shrink-0" />
                  <div>
                    <h3 className="text-foreground font-semibold">Tranquilidad total</h3>
                    <p className="text-muted-foreground">
            ...
            <div className="from-primary/20 to-primary/5 rounded-2xl bg-gradient-to-br p-8 text-center">
              ...
              <h3 className="text-foreground mb-2 text-2xl font-bold">+10,000 usuarios confían en nosotros</h3>
              <p className="text-muted-foreground">
      ...
      <section className="container mx-auto px-4 py-16">
        <Card className="bg-primary/5 border-primary/20">
          <CardContent className="py-12 text-center">
            <h2 className="text-foreground mb-4 text-3xl font-bold">¿Listo para comenzar?</h2>
